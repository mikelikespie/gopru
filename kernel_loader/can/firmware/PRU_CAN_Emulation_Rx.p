...
//    MOV32     	RegisterValue, 0x00000000
    ...
    // Enable the Timer0 in auto reload-shot mode
    LDI       	RegisterValue.w0, 0x0080
    SBBO      	RegisterValue.w0, RegisterOffset, TMR_TCR_OFFSET,  2
	
    // Set the Interrupt polarity registers
    //MOV32     RegisterOffset, (INTC_REGS_BASE + INTC_SYS_INT_REGS_OFFSET)
    //MOV32     RegisterValue, 0xFFFFFFFF
    //SBBO      RegisterValue, RegisterOffset, 0x00, 4
    //SBBO      RegisterValue, RegisterOffset, 0x04, 4

    // Set the Interrupt type registers
    //MOV32     RegisterValue, 0x1C000000
    //SBBO      RegisterValue, RegisterOffset, 0x80, 4
    //LDI       RegisterValue.w2, #0x0000
    //SBBO      RegisterValue, RegisterOffset, 0x84, 4	
...
RECIEVE_GPIO_POLL_LOOP:  
	...
	QBEQ    	BUS_OFF_CHECK, FrameLength.w0, 7           // 11 bit high received, check for Bus Off
...
BUS_OFF_CHECK:
	...
	QBBC        START_OF_FRAME, RegisterValue, 4
	
BUS_OFF_CHECK_LOOP:	
	MOV32      	RegisterOffset, PRU_CAN_TX_GLOBAL_STATUS_REGISTER
    LBBO      	RegisterValue, RegisterOffset, 0,  4
	QBBS        BUS_OFF_CHECK_LOOP, RegisterValue, 4
...
//	XOR	  	r30, r30,RegisterValue	
    ...
    LDI       	RegisterValue.w0, 0x40												//Reload the bit delay
    SBBO      	RegisterValue.w0, RegisterOffset, TMR_TCR_OFFSET,  2	
...
//===============================================================
    ...
    LDI       	RegisterValue.w0, 0x80												//Reload the bit delay
    SBBO      	RegisterValue, RegisterOffset, TMR_TCR_OFFSET,  2	
...
//	MOV32   	RegisterValue, PRU_CAN_RX_GLOBAL_STATUS_REGISTER 
//	LBBO    	RegisterValue,RegisterValue,0,4     
//	QBBS    	CAN_EMULATION_RX_START,RegisterValue,7
    ...
    MOV32       RegisterValue, 0x01C14150
	LBBO		RegisterOffset, RegisterValue,0,4
	LSR			RegisterOffset, RegisterOffset, 4
	LSL			RegisterOffset, RegisterOffset, 4
	SET			RegisterOffset, 3
	SBBO        RegisterOffset,RegisterValue,0,4              
	
	MOV32       RegisterValue, 0x01E26060
	...
	MOV32      	RegisterOffset, PRU_CAN_TX_GLOBAL_STATUS_REGISTER
	LBBO		RegisterValue, RegisterOffset, 0, 4
	QBBS        CAN_GENERATE_PASSIVE_ERROR, RegisterValue, 3
...
CAN_GENERATE_PASSIVE_ERROR:	
	...
	MOV32       RegisterValue,  0x01E26068
    MOV32       RegisterOffset, 0x00800000
...
//	MOV32       RegisterValue, 0x01E2606C
//    MOV32       RegisterOffset,0x800000
...
DATA_ANALYSIS_1abc:	
    ...
    MOV     	RegisterValue, FrameLength.w0
    SUB     	RegisterValue, RegisterValue, 16
...
DATA_RECEIVE_COMPLETED_CRC:        
	...
	//QBEQ    	CRC_CHECK, CanFrameState.b0, STD_REMOTE_FRAME
	//QBEQ    	CRC_CHECK, CanFrameState.b0, EXTD_REMOTE_FRAME
...
//====================================================================	
    ...
    SBBO        ErrorCounter,RegisterValue,0,4
	QBNE        COMPARE_CAN_ID,ErrorCounter,127
	
	MOV32       RegisterValue,PRU_CAN_TX_ERROR_COUNTER_REGISTER
    LBBO        ErrorCounter,RegisterValue,0,4	
	QBGE        COMPARE_CAN_ID,ErrorCounter,127
