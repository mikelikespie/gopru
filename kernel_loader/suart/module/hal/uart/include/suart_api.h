...
#define PRU_NUM_OF_CHANNELS		16
	...
	typedef struct {
		unsigned short CH_Ctrl;
				  /**< PRU SUART control register */
		unsigned short CH_Config1;
				   /**< PRU SUART configuration1 register */
		unsigned short CH_Config2;
				   /**< PRU SUART configuration2 register */
		unsigned short CH_TXRXStatus;
				      /**< PRU SUART TX/RX status register */
		unsigned int CH_TXRXData;
				  /**< PRU SUART TX/RX data register */
		unsigned int Reserved1;
				/**< Reserved 1  */
	} pru_suart_regs[PRU_NUM_OF_CHANNELS];
